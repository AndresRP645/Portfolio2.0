...
const HeaderIntro: React.FC = () => {
  ...
  return (
    <section
      ...
      id="home"
    >
      <RadialGradient scale="scale-y-80" opacity="opacity-40" />
      ...
      <p className="w-1/2 text-center max-lg:hidden profile-description">
          {language === "ES"
      ...
      <div className="button-container flex items-center justify-center mr-8 gap-10 mb-12 max-lg:flex-col max-lg:items-center">
        ...
        <Button
            label={language === "ES" ? headerIntroData.cv.label.es : headerIntroData.cv.label.en}
            iconSVG={headerIntroData.cv.icon}
            link="/files/ARP-CV.pdf"
            buttoncolor={headerIntroData.cv.color}
            target="_blank"
          />
      </div>
