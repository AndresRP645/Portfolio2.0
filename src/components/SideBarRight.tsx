...
const SiteBarLeft: React.FC = () => {
  return (
    <div className="absolute flex items-center flex-col  bottom-0 right-0 mr-8 h-[70vh] max-lg:hidden">
      <div className=" h-[80%] w-[4rem] flex items-center justify-center mr-2">
        <Link
          to={sideBarRightMail.link}
          className=" text-gray-700 mb-2 [writing-mode:vertical-lr] absolute top-0 right-0  h-[100%] text-[--purple] hover:text-[--lightblue] transition-all duration-200 "
        >
